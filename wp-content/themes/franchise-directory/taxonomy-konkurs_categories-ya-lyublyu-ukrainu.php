        ...
        <main id="main-concurs-<?php echo $post->ID; ?>" class="concurses-list concurs-main">
            ...
            <section class="left-part">
                ...
                <div class="concurs-header">
                    ...
                    <label for=""><i class="fas fa-trophy-alt"></i> &nbsp <b>Конкурс "<?php echo "$tax_term"; ?>
                            "</b></label>
                    <?php
                    ...
                    while ($custom_loop_rand->have_posts()) : $custom_loop_rand->the_post(); ?>
                        <div class="concurs-random-entry-thumbnail" style="">
                            ...
                            <img style="visibility: visible; max-height: 230px" width="auto" height="auto"
                                 src="<?php echo esc_url($post_medium_img); ?>"
                                 data-src="<?php echo esc_url($post_full_img); ?>" class="fr_lazyload"
                                 alt="<?php the_title_attribute(); ?>">
                            <div style="display: flex; flex-flow: column">
                                <a class="concurs-title" href="<?php get_the_permalink() ?>"
                                   id=""><?php the_title() ?></a>
                                <a class="concurs-comments_link" href="<?php comments_link(); ?>"> <i
                                            class="far fa-pencil"></i>Оставить комментарий</a>
                        ...
                        while ($custom_loop->have_posts()) : $custom_loop->the_post(); ?>
                            <div class="concurs-entry-thumbnail col-md-4" style="">
                                <div class="concurs-image">
                                    <?php $post_medium_img = $fr_obj->get_thumbnail(get_the_ID(), 'small');
                                    $post_full_img = $fr_obj->get_thumbnail(get_the_ID(), 'full'); ?>
                                    <img style="visibility: visible; max-height: 250px; max-width: 210px;" width="auto"
                                         height="auto" src="<?php echo esc_url($post_medium_img); ?>"
                                         data-src="<?php echo esc_url($post_full_img); ?>" class="fr_lazyload"
                                         alt="<?php the_title_attribute(); ?>">
                                </div>
                                <a class="concurs-title"
                    ...
                    <div id="concurs-rules" class="">
                        ...
                        <section class="contest-stages">
                            <table width="690px" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="background-image: url('http://priluki.in.ua/skin/index/img/contest/big_rounded_bg.gif');background-position: top left;background-repeat: repeat-y;">
                                        <div style="padding: 12px;font-size: 14px;" align="center">
                                            <p><span style="color: #cc1c24;font-size: 20px;">Определение победителей и вручение призов</span>
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="6"><img
                                                src="http://priluki.in.ua/skin/index/img/contest/big_rounded_footer.gif"
                ...
                <div class="contests-like-cat" style="margin-bottom: 10px">
                    ...
                    <div class="like-content">
                        ...
                        <input id="tax-link" type="text" value="<?php echo get_term_link($term_id, $taxonomy); ?>"
                               style="width: 330px">
                    </div>
