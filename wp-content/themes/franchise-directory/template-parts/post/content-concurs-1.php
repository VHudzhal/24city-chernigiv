...
<section class="left-part">
    <div class="concurs-header">
        ...
        <div class="concurs-single-entry-thumbnail" style="">
            ...
            <div class="zoom-in-photo">
                <a style="background: none; border: none; display: flex;" data-toggle="modal" data-target="#imagemodal">
                    <i class="fas fa-search-plus" style="color: black"></i><h5>Увеличить фото</h5></a>
    ...
    <div id="posts-carousel" class="concurs-1">
        <?php
