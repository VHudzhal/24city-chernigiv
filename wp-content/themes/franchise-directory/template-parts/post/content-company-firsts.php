...
<li class="line-content" style="background-color: yellowgreen">
                        <div class="company-excerpt">
                            <!--Company description begin-->
                            <div class="descr-company" style="flex: 0 0 40%">
           ...
           //             echo '</span>';
                    ...
                    <div id="company-links" class="part-block">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="excerpt-company" style="flex: 0 0 40%">
...
<!-- Company description end -->
                            <div class="company-shares" style="flex: 0 0 20%"></div>
