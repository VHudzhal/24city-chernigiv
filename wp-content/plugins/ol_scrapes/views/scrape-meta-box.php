...
model.scrape_first_run_times = [
	{ id: 'hour_0', name: 'Immediately' },
	{ id: 'hour_1', name: '1 hour later' },
	{ id: 'hour_2', name: '2 hours later' },
	{ id: 'hour_3', name: '3 hours later' },
	{ id: 'hour_4', name: '4 hours later' },
	{ id: 'hour_5', name: '5 hours later' },
	{ id: 'hour_6', name: '6 hours later' },
	{ id: 'hour_7', name: '7 hours later' },
	{ id: 'hour_8', name: '8 hours later' },
	{ id: 'hour_9', name: '9 hours later' },
	{ id: 'hour_10', name: '10 hours later' },
	{ id: 'hour_11', name: '11 hours later' },
	{ id: 'hour_12', name: '12 hours later' },
	{ id: 'hour_13', name: '13 hours later' },
	{ id: 'hour_14', name: '14 hours later' },
	{ id: 'hour_15', name: '15 hours later' },
	{ id: 'hour_16', name: '16 hours later' },
	{ id: 'hour_17', name: '17 hours later' },
	{ id: 'hour_18', name: '18 hours later' },
	{ id: 'hour_19', name: '19 hours later' },
	{ id: 'hour_20', name: '20 hours later' },
	{ id: 'hour_21', name: '21 hours later' },
	{ id: 'hour_22', name: '22 hours later' },
	{ id: 'hour_23', name: '23 hours later' },
	{ id: 'hour_24', name: '24 hours later' }
];
		...
		<div class="row">
			<div class="col-xs-12">
								...
								<div class="panel-body">
									<div class="form-group" ng-class="{'has-error' : (form.scrape_translate_source.$invalid && (form.scrape_translate_source.$dirty || submitted)) || (form.scrape_translate_target.$invalid && (form.scrape_translate_target.$dirty || submitted))}">
										...
										<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-12">
                                                    <?php if(DEMO) : ?><p class="help-block success"> Translate feature is not available on demo</p><?php endif; ?>
													<div class="checkbox"><label><input type="checkbox" name="scrape_translate_enable" ng-model="model.scrape_translate_enable" <?php if(DEMO) echo " disabled"; ?>> <?php _e('Enable', 'ol-scrapes'); ?></label></div>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group" ng-if="model.scrape_spin_enable">
												<div class="col-sm-12">
													<div class="alert alert-warning">
														<p>Spinner feature requires <strong>The Best Spinner</strong> account which you can create new from <a href="http://octolooks.jonathanleger.zaxaa.com/s/4152949213724" target="_blank">http://thebestspinner.com</a>. You can also use other 3rd party <strong>spinner plugins</strong> for WordPress.</p>
													</div>
												</div>
							...
							<div id="collapse-5" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<div class="form-group" ng-class="{'has-error' : form.scrape_finish_repeat.$invalid && (form.scrape_finish_repeat.$dirty || submitted)}" ng-if="model.scrape_type && (model.scrape_type == 'list' || model.scrape_type == 'feed') && (model.scrape_unique_title || model.scrape_unique_content || model.scrape_unique_url)">
										<label class="col-sm-4 control-label"><?php _e('Complete run on loop', 'ol-scrapes'); ?> <i class="icon ion-help-circled" data-toggle="popover" data-content="<?php _e('The field to set how many on existing post occurrence is needed to stop the task until next run time in order to save '.S_WORD.' resources (Required).', 'ol-scrapes'); ?>"></i></label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-4 control-label"><?php _e('Filters', 'ol_imports'); ?> <i class="icon ion-help-circled" data-toggle="popover" data-content="<?php _e('The option to set filters which are applied to posts before they are created.', 'ol-scrapes'); ?>"></i></label>
										<div class="col-sm-8">
                                            <?php
                                            ...
                                            <div class="form-group">
												<div class="col-sm-12">
													<div class="input-group">
														<div class="input-group-addon"><?php _e('Operator', 'ol_imports'); ?></div>
														<div class="select">
															<select name="scrape_filters_operators[]" class="form-control">
																<option value="contains" <?php if($scrape_filters_operators[$i] == "contains") {echo "selected"; } ?>><?php _e('Contains', 'ol_imports'); ?></option>
																<option value="does_not_contain" <?php if($scrape_filters_operators[$i] == "does_not_contain") {echo "selected"; } ?>><?php _e('Does not contain', 'ol_imports'); ?></option>
																<option value="exists" <?php if($scrape_filters_operators[$i] == "exists") {echo "selected"; } ?>><?php _e('Exists', 'ol_imports'); ?></option>
																<option value="not_exists" <?php if($scrape_filters_operators[$i] == "not_exists") {echo "selected"; } ?>><?php _e('Not exists', 'ol_imports'); ?></option>
																<option value="equal_to" <?php if($scrape_filters_operators[$i] == "equal_to") {echo "selected"; } ?>><?php _e('Equal to', 'ol_imports'); ?></option>
																<option value="not_equal_to" <?php if($scrape_filters_operators[$i] == "not_equal_to") {echo "selected"; } ?>><?php _e('Not equal to', 'ol_imports'); ?></option>
																<option value="greater_than" <?php if($scrape_filters_operators[$i] == "greater_than") {echo "selected"; } ?>><?php _e('Greater than', 'ol_imports'); ?></option>
																<option value="less_than" <?php if($scrape_filters_operators[$i] == "less_than") {echo "selected"; } ?>><?php _e('Less than', 'ol_imports'); ?></option>
															</select>
														</div>
												...
												<div class="col-sm-12">
													<div class="input-group">
														<div class="input-group-addon"><?php _e('Field', 'ol_imports'); ?></div>
														<div class="select">
															<select name="scrape_filters_fields[]" class="form-control">
																<option value="title" <?php if($scrape_filters_fields[$i] == "title") {echo "selected"; } ?>><?php _e('Title', 'ol_imports'); ?></option>
																<option value="content" <?php if($scrape_filters_fields[$i] == "content") {echo "selected"; } ?>><?php _e('Content', 'ol_imports'); ?></option>
																<option value="excerpt" <?php if($scrape_filters_fields[$i] == "excerpt") {echo "selected"; } ?>><?php _e('Excerpt', 'ol_imports'); ?></option>
																<option value="featured_image" <?php if($scrape_filters_fields[$i] == "featured_image") {echo "selected"; } ?>><?php _e('Featured image', 'ol_imports'); ?></option>
																<option value="date" <?php if($scrape_filters_fields[$i] == "date") {echo "selected"; } ?>><?php _e('Date', 'ol_imports'); ?></option>
																<?php if (strpos($scrape_filters_fields[$i], 'custom_field_') !== false) : ?>
																<option value="<?php echo $scrape_filters_fields[$i]; ?>" selected><?php _e('Custom field', 'ol_imports'); ?> - <?php echo $scrape_custom_fields[substr($scrape_filters_fields[$i], 13)]['name'] ?></option>
																<?php endif; ?>
															</select>
														</div>
													</div>
												...
												<div class="col-sm-12">
													<div class="input-group">
														<div class="input-group-addon"><?php _e('Value', 'ol_imports'); ?></div>
														<input type="text" name="scrape_filters_values[]" value="<?php echo $scrape_filters_values[$i]; ?>" placeholder="<?php _e('e.g. value', 'ol_imports'); ?>" class="form-control">
													</div>
												</div>
											</div>
                                            <?php endif; endfor; endif; ?>
											...
											<div class="form-group">
												<div class="col-sm-12">
													<button type="button" class="btn btn-link" ng-click="add_field($event, 'filter')"><i class="icon ion-plus-circled"></i> <?php _e('Add new filter', 'ol_imports'); ?></button>
												</div>
											</div>
										</div>
									</div>
						...
						<div id="panel_06" class="panel" ng-show="model.scrape_type">
							...
							<div id="collapse-6" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-4 control-label"><?php _e('First run', 'ol_imports'); ?> <i class="icon ion-help-circled" data-toggle="popover" data-content="<?php _e('The option to select first run time of task.', 'ol-scrapes'); ?>"></i></label>
										<div class="col-sm-8">
											<div class="form-group">
												<div class="col-sm-12">
													<div class="slider" data-value="scrape_first_run_time" data-values="scrape_first_run_times"></div>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="sidebar" ng-if="model.scrape_type">
					<div class="fixed">
						<?php if (empty($_GET['post'])) { ?>
						<button type="submit" name="publish" value="Publish" id="publish" class="btn btn-primary" ng-class="{'disabled' : form.$invalid}" ng-click="submit($event)"><i class="icon ion-arrow-right-c"></i><span><?php _e('Save', 'ol_imports'); ?></span></button>
						<?php } else { ?>
						<button type="submit" name="save" value="Update" id="publish" class="btn btn-primary" ng-class="{'disabled' : form.$invalid}" ng-click="submit($event)"><i class="icon ion-arrow-right-c"></i><span><?php _e('Save', 'ol_imports'); ?></span></button>
						<?php } ?>
