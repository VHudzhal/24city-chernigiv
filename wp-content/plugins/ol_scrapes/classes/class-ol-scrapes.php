...
//			delete_transient('lock_' . $post_id);
	...
	public function translate_string($string, $from, $to, $return_html) {
		global $post_fields, $api, $payload, $headers, $from_language, $to_language, $html_string;
	...
	private function return_html_args($meta_vals = null) {
		$args = array(
			'sslverify' => false, 'timeout' => is_null($meta_vals) ? 60 : $meta_vals['scrape_timeout'][0], 'user-agent' => get_site_option('scrape_user_agent'), //'httpversion' => '1.1',
