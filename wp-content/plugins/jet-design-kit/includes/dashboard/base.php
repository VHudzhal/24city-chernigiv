...
if ( ! class_exists( 'Jet_Design_Kit_Dashboard_Base' ) ) {

	/**
	 * Define Jet_Design_Kit_Dashboard_Base class
	 */
	abstract class Jet_Design_Kit_Dashboard_Base {
		 ...
		 * Class constructor
		 */
		public function __construct( Jet_Design_Kit_Dashboard $manager ) {

			$this->manager = $manager;

			add_action( 'jet-design-kit/dashboard/actions/' . $this->get_slug(), array( $this, 'attach_handlers' ) );
		...
		public function init_builder() {
			...
			$builder_data = jet_design_kit()->framework->get_included_module_data( 'cherry-x-interface-builder.php' );
