...
class Jet_Design_Kit_Templates_Source_Api extends Jet_Design_Kit_Templates_Source_Base {
	...
	*/
	public function get_version() {
		...
		if ( ! $version ) {
			$version = jet_design_kit()->api->get_info( 'api_version' );
	...
	*/
	...
	public function remote_get_templates( $tab ) {
		...
		$api_url = jet_design_kit()->api->api_url( 'templates' );
	...
	public function remote_get_categories( $tab ) {
		...
		$api_url = jet_design_kit()->api->api_url( 'categories' );
	...
	public function remote_get_keywords( $tab ) {
		...
		$api_url = jet_design_kit()->api->api_url( 'keywords' );
	...
	*/
	public function get_item( $template_id, $tab = false ) {
		...
		$api_url = jet_design_kit()->api->api_url( 'template' );
