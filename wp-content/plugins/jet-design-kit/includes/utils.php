...
if ( ! class_exists( 'Jet_Design_Kit_Utils' ) ) {

	/**
	 * Define Jet_Design_Kit_Utils class
	 */
	class Jet_Design_Kit_Utils {
		...
		public static function get_post_types() {
			...
			$deprecated = apply_filters(
				'jet-design-kit/post-types-list/deprecated',
				array(
					'attachment',
					'elementor_library',
					jet_design_kit()->templates->post_type,
				)
			);
		...
		public static function get_taxonomies() {
			...
			$deprecated = apply_filters(
				'jet-design-kit/taxonomies-list/deprecated',
				array()
			);
		...
		public static function install_plugin( $plugin, $plugin_url = false ) {
			...
			if ( ! $plugin ) {
				$status['errorMessage'] = __( 'Plugin slug is required', 'jet-design-kit' );
				wp_send_json_error( $status );
			}

			if ( ! $plugin_url ) {

				$api_url = jet_design_kit()->api->api_base();
				$license = jet_design_kit()->dashboard->get( 'license' );
		...
		public static function activate_plugin( $plugin ) {
			...
			wp_send_json_success( apply_filters( 'jet-design-kit/utils/activate-plugin-response', $status ) );
