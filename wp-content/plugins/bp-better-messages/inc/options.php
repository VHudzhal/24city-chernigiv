...
class BP_Better_Messages_Options
{
    ...
    public function update_settings( $settings )
    {
        ...
        if( ! isset($settings['allowDeleteMessages']) ) $settings[ 'allowDeleteMessages' ] = '0';
        ...
        if( ! isset($settings['disableDeleteThreadCheck']) ) $settings[ 'disableDeleteThreadCheck' ] = '0';
        if( ! isset($settings['oEmbedEnable']) ) $settings[ 'oEmbedEnable' ] = '0';
        if( ! isset($settings['disableEnterForDesktop']) ) $settings[ 'disableEnterForDesktop' ] = '0';
        if( ! isset($settings['restrictNewThreads']) ) $settings[ 'restrictNewThreads' ] = [];
        if( ! isset($settings['restrictNewReplies']) ) $settings[ 'restrictNewReplies' ] = [];
        if( ! isset($settings['videoCalls']) ) $settings[ 'videoCalls' ] = '0';
        if( ! isset($settings['audioCalls']) ) $settings[ 'audioCalls' ] = '0';
        if( ! isset($settings['blockScroll']) ) $settings[ 'blockScroll' ] = '0';
        if( ! isset($settings['userListButton']) ) $settings[ 'userListButton' ] = '0';
        if( ! isset($settings['combinedView']) ) $settings[ 'combinedView' ] = '0';
