...
; ( function ( factory, global ) {
    ...
    var getDefaultOptions = function () {
        return $.fn.BPemojioneArea && $.fn.BPemojioneArea.defaults ? $.fn.BPemojioneArea.defaults : {
            attributes: {
                dir               : "ltr",
                spellcheck        : false,
                autocomplete      : "off",
    ...
    function delimitWithSpaces(str, template) {
        return str.replace(uniRegexp, function(unicodeChar) {
            return ' ' + unicodeChar + ' ';
        });
    }
    ...
    function calcButtonPosition() {
        ...
        if (current !== offset) {
            var editor = $( self.editor[0] );
            var emojiarea = editor.parent();
            var uploadBtn = emojiarea.find('.upload-btn');

            if( uploadBtn.length > 0 ){
                uploadBtn.css({marginRight: offset});
            }
