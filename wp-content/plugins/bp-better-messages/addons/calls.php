    ...
    class BP_Better_Messages_Calls
    {
        ...
        public function call_button($thread_id, $participants, $is_mini){
            ...
            if( count( $participants['recipients'] ) === 1 ){
                if( $this->video ){
                    echo '<a href="#" class="video-call" data-user-id="' . $participants[ "recipients" ][0] . '"  title="' . __("Video Call", "bp-better-messages") . '"><i class="fas fa-video"></i></a>';
                }

                if( $this->audio ){
                    echo '<a href="#" class="audio-call" data-user-id="' . $participants[ "recipients" ][0] . '"  title="' . __("Audio Call", "bp-better-messages") . '"><i class="fas fa-phone"></i></a>';
                }
            }
        }
