...
?><div class="bp-messages-wrap bp-messages-wrap-main" data-thread-id="<?php esc_attr_e($thread_id); ?>">
    <div class="chat-header">
        ...
        <?php if(count($participants['links']) < 2) {
            if($is_mini){
                ...
                echo apply_filters('bp_better_messages_full_chat_username', $participants[ 'links' ][0], $participants[ 'recipients' ][0], $thread_id);
            }
        } else {
        ...
        <div class="chat-controls">
            <?php /*<a href="#" class="bpbm-edit" data-nonce="<?php echo wp_create_nonce('edit_message_' . $thread_id); ?>"><i class="fas fa-pencil-alt"></i> <?php _e('Edit', 'bp-better-messages'); ?></a> */ ?>
            <?php /*<a href="#" class="bpbm-fave"><i class="fas fa-star"></i> Star</a> */ ?>
    ...
    <?php
    if( $side_threads ) {
        echo '<div class="bp-messages-side-threads-wrapper">';
