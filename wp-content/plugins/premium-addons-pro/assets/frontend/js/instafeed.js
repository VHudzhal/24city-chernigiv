...
(function () {
    ...
    Instafeed = (function () {
        ...
        Instafeed.prototype.parse = function (response) {
            ...
            var anchor, childNodeCount, childNodeIndex, childNodesArr, e, eMsg, fragment, header, htmlString, httpProtocol, i, image, imageString, imageUrl, images, img, imgOrient, imgUrl, instanceName, j, k, len, len1, len2, node, parsedLimit, reverse, sortSettings, targetEl, tmpEl;
                    ...
                    for (i = 0, len = images.length; i < len; i++) {
                        ...
                        if (-1 !== j.indexOf(true)) {
                            imageString = this._makeTemplate(this.options.template, {
                                ...
                                caption: this._getObjectProperty(image, "old" === this.options.api ? "caption.text" : "caption"),
