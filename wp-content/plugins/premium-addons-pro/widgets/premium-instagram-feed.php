...
class Premium_Instagram_Feed extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control('old_api_notice', 
            [
                'raw'               => __('<b>Important:</b> This API will be deprecated soon, so it\'s not recommended if you\'re adding the widget for the first time. For further reading, please check this <a href="https://www.instagram.com/developer/" target="_blank">page</a>', 'premium-addons-pro'),
                'type'              => Controls_Manager::RAW_HTML,
        ...
        $this->add_control('new_api_notice', 
            [
                'raw'               => __('<b>Important:</b> The amount of information given about Instagram media is greatly reduced in the new API', 'premium-addons-pro'),
                'type'              => Controls_Manager::RAW_HTML,
                'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                'condition' => [
                    'api_version'   => 'new'
